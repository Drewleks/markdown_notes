...
* [Digital@Scale](books/digital_scale/digital_scale.md)
* [Экстремальное программирование. Разработка через тестирование](books/ekstremalnoe_programmirovanie/ekstremalnoe_programmirovanie.md)
* [Big data простым языком](books/big_data_prostim_yazikom/big_data_prostim_yazikom.md)
* [Data Analytics: 4 Books in 1](books/data_analytics/data_analytics.md)
* [Измеряйте самое важное. Как Google, Intel и другие компании добиваются роста с помощью OKR](books/izmeryaite_samoe_vazhnoe/izmeryaite_samoe_vazhnoe.md)
* [О чем говорят цифры. Как понимать и использовать данные](books/o_chem_govoryat_tsifri/o_chem_govoryat_tsifri.md)